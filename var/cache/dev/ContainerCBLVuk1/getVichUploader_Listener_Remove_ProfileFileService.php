...
// Returns the private 'vich_uploader.listener.remove.profile_file' shared service.
...
return $this->privates['vich_uploader.listener.remove.profile_file'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('profile_file', ($this->privates['vich_uploader.adapter.orm'] ?? ($this->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($this->privates['vich_uploader.metadata_reader'] ?? $this->getVichUploader_MetadataReaderService()), ($this->services['vich_uploader.upload_handler'] ?? $this->load('getVichUploader_UploadHandlerService.php')));
