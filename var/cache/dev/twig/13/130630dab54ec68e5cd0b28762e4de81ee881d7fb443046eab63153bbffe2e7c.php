...
class __TwigTemplate_ebeb1e453050a7e5200f9ce307ac392420cd01c25f690602fe02955164d16cc8 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        yield "\" onsubmit=\"return confirm('Confirmez-vous la suppression de la catégorie ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 1, $this->source); })()), "name", [], "any", false, false, false, 1), "html", null, true);
        yield " ?');\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('category_delete', {'id': category.id}) }}\" onsubmit=\"return confirm('Confirmez-vous la suppression de la catégorie {{ category.name }} ?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
