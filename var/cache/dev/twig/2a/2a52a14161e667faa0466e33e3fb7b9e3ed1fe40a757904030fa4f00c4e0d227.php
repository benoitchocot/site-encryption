...
class __TwigTemplate_0cdb36197df2b2d883899ba1e27c890ab0b1cbecb120ff75c79aadd9f82d65df extends Template
{
    private $source;
    private $macros = [];
...
$context["key"], "hit_read_ratio"))) {
                            // line 113
                            yield "                                                ";
                            ((((isset($context["value"]) || array_key_exists("value", $context)) &&  !(null === $context["value"]))) ? (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["value"], "html", null, true)) : (yield 0));
                            yield " <span class=\"unit\">%</span>
                                            ";
                        } else {
                            // line 115
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "/home/bonoit/Projets Web/site-encryption/vendor/symfony/web-profiler-bundle/Resources/views/Collector/cache.html.twig");
    }
}
