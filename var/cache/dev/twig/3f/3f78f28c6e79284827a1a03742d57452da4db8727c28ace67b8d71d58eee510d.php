...
class __TwigTemplate_2bc22f8b87cdbc721685ce48bcbe047bb21471d8847dfc572540edc0c6d580a7 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "data", [], "any", false, true, false, 6), "unavailable_migrations_count", [], "any", true, true, false, 6)) {
            ...
            // line 9
            yield "        ";
            if (((1 === CoreExtension::compare((isset($context["unavailable_migrations"]) || array_key_exists("unavailable_migrations", $context) ? $context["unavailable_migrations"] : (function () { throw new RuntimeError('Variable "unavailable_migrations" does not exist.', 9, $this->source); })()), 0)) || (1 === CoreExtension::compare((isset($context["new_migrations"]) || array_key_exists("new_migrations", $context) ? $context["new_migrations"] : (function () { throw new RuntimeError('Variable "new_migrations" does not exist.', 9, $this->source); })()), 0)))) {
                // line 10
                yield "            ";
                ...
                // line 12
                yield "            ";
                $context["status_color"] = (((1 === CoreExtension::compare((isset($context["unavailable_migrations"]) || array_key_exists("unavailable_migrations", $context) ? $context["unavailable_migrations"] : (function () { throw new RuntimeError('Variable "unavailable_migrations" does not exist.', 12, $this->source); })()), 0))) ? ("yellow") : (""));
                // line 13
                yield "            ";
            ...
            ";
                ...
                <div class=\"sf-toolbar-info-piece\">
                    ...
                    <span class=\"sf-toolbar-status ";
                    // line 31
                    yield (((1 === CoreExtension::compare((isset($context["unavailable_migrations"]) || array_key_exists("unavailable_migrations", $context) ? $context["unavailable_migrations"] : (function () { throw new RuntimeError('Variable "unavailable_migrations" does not exist.', 31, $this->source); })()), 0))) ? ("sf-toolbar-status-yellow") : (""));
                    yield "\">";
                ...
                <div class=\"sf-toolbar-info-piece\">
                    ...
                    <span class=\"sf-toolbar-status ";
                    // line 39
                    yield (((1 === CoreExtension::compare((isset($context["new_migrations"]) || array_key_exists("new_migrations", $context) ? $context["new_migrations"] : (function () { throw new RuntimeError('Variable "new_migrations" does not exist.', 39, $this->source); })()), 0))) ? ("sf-toolbar-status-red") : (""));
                    yield "\">";
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "data", [], "any", false, true, false, 50), "unavailable_migrations_count", [], "any", true, true, false, 50)) {
            ...
            // line 53
            yield "        ";
            $context["label"] = (((1 === CoreExtension::compare((isset($context["unavailable_migrations"]) || array_key_exists("unavailable_migrations", $context) ? $context["unavailable_migrations"] : (function () { throw new RuntimeError('Variable "unavailable_migrations" does not exist.', 53, $this->source); })()), 0))) ? ("label-status-warning") : (""));
            // line 54
            yield "        ";
            ...
            ";
            // line 58
            if (((1 === CoreExtension::compare((isset($context["unavailable_migrations"]) || array_key_exists("unavailable_migrations", $context) ? $context["unavailable_migrations"] : (function () { throw new RuntimeError('Variable "unavailable_migrations" does not exist.', 58, $this->source); })()), 0)) || (1 === CoreExtension::compare((isset($context["new_migrations"]) || array_key_exists("new_migrations", $context) ? $context["new_migrations"] : (function () { throw new RuntimeError('Variable "new_migrations" does not exist.', 58, $this->source); })()), 0)))) {
                // line 59
...
{% endmacro %}
", "@DoctrineMigrations/Collector/migrations.html.twig", "/home/bonoit/Projets Web/site-encryption/vendor/doctrine/doctrine-migrations-bundle/Resources/views/Collector/migrations.html.twig");
    }
}
