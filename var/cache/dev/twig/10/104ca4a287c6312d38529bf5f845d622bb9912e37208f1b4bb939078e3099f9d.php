...
class __TwigTemplate_611ccf508a12468f9b315f0d581d3cff388628fbb1088fa6fea1d858dc5eae43 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <table>
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 41, $this->source); })()), "mappings", [], "any", false, false, false, 41));
        foreach ($context['_seq'] as $context["class"] => $context["data"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["mdata"]) {
                ...
                yield "                    <tr>
                        <td>";
                // line 47
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["mdata"], "propertyName", [], "any", false, false, false, 47), "html", null, true);
                yield "</td>
                        <td>";
                // line 48
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["mdata"], "mapping", [], "any", false, false, false, 48), "html", null, true);
                yield "</td>
                        <td>";
                // line 49
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["mdata"], "fileNameProperty", [], "any", false, false, false, 49), "html", null, true);
                yield "</td>
                    </tr>
                ";
            }
...
";
    ...
    {
        return array (  215 => 54,  209 => 53,  207 => 52,  198 => 49,  194 => 48,  190 => 47,  187 => 46,  183 => 45,  178 => 43,  175 => 42,  171 => 41,  158 => 30,  148 => 29,  134 => 24,  132 => 23,  128 => 21,  126 => 20,  116 => 19,  103 => 16,  100 => 15,  93 => 12,  89 => 10,  87 => 9,  84 => 8,  77 => 6,  74 => 5,  71 => 4,  61 => 3,  38 => 1,);
    }
