...
class __TwigTemplate_ed36d8b7117e4fcc86cc0d62417a2024f5ed01c7189dcb5492d0e63dd49a3566 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"text-right\">
        ...
        yield "\"><i class=\"fas fa-plus-circle mr-1\"></i>Ajouter une catégorie</a>
    </div>
    <table class=\"table table-hover\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            // line 26
            yield "                    <a title=\"Editer\" class=\"btn btn-sm btn-primary ml-2\"
                       href=\"";
            // line 27
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("category_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 27)]), "html", null, true);
            yield "\">
        ...
        if (!$context['_iterated']) {
            // line 33
            yield "            <tr>
                <td colspan=\"2\">Pas de catégorie enregistrée</td>
            </tr>
        ";
        }
...
";
    ...
    ";
        // line 43
        yield $this->extensions['Symfony\WebpackEncoreBundle\Twig\EntryFilesTwigExtension']->renderWebpackLinkTags("category");
        yield "
";
    ...
    {
        return array (  202 => 43,  197 => 42,  187 => 41,  174 => 37,  165 => 33,  146 => 27,  143 => 26,  137 => 24,  135 => 23,  130 => 21,  127 => 20,  109 => 19,  96 => 9,  91 => 6,  81 => 5,  61 => 3,  38 => 1,);
    }
...
{% block title %}Big Bill | Catégorie{% endblock %}

{% block body %}
    <h1>Liste des catégories</h1>

    <div class=\"text-right\">
        <a class=\" btn btn-primary mb-3\" href=\"{{ path('category_new') }}\"><i class=\"fas fa-plus-circle mr-1\"></i>Ajouter une catégorie</a>
    </div>
    <table class=\"table table-hover\">
        <thead>
        <tr>
        ...
        {% for category in categories %}
            <tr>
                ...
                <td class=\"btn-row\">
                    ...
                    {% endif %}
                    <a title=\"Editer\" class=\"btn btn-sm btn-primary ml-2\"
