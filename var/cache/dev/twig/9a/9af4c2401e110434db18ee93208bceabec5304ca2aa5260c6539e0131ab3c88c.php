...
class __TwigTemplate_9ed080329871ea3c6dee4bc729d5913102af97f6031fc5f286db248915389dd2 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        yield from         $this->loadTemplate("project/_addFeatures.html.twig", "project/edit.html.twig", 7)->unwrap()->yield($context);
        // line 8
        yield "
    ";
        // line 9
    ...
    ";
        // line 10
        yield from         $this->loadTemplate("project/_form.html.twig", "project/edit.html.twig", 10)->unwrap()->yield(CoreExtension::merge($context, ["buttonName" => "Enregistrer les modifications"]));
        // line 11
        yield "    ";
...
";
    ...
    ";
        // line 17
        yield $this->extensions['Symfony\WebpackEncoreBundle\Twig\EntryFilesTwigExtension']->renderWebpackLinkTags("projectDetails");
        yield "
    ";
        // line 18
        yield $this->extensions['Symfony\WebpackEncoreBundle\Twig\EntryFilesTwigExtension']->renderWebpackLinkTags("easyAutocomplete");
        yield "
";
    ...
    public function block_javascripts($context, array $blocks = [])
    {
        ...
        // line 21
        yield "    <script type=\"text/javascript\" src=\"https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js\"></script>
    ";
        // line 22
    ...
    ";
        // line 23
        yield $this->extensions['Symfony\WebpackEncoreBundle\Twig\EntryFilesTwigExtension']->renderWebpackScriptTags("easyautocomplete");
        yield "
";
    ...
    {
        return array (  170 => 23,  166 => 22,  163 => 21,  153 => 20,  140 => 18,  136 => 17,  131 => 16,  121 => 15,  106 => 11,  104 => 10,  100 => 9,  97 => 8,  95 => 7,  92 => 6,  82 => 5,  62 => 3,  39 => 1,);
    }
...
{% block body %}
    ...
    {% include 'project/_addFeatures.html.twig' %}

    {{ form_start(form) }}
    {% include 'project/_form.html.twig' with {'buttonName': 'Enregistrer les modifications'} %}
    {{ form_end(form) }}
...
{% block stylesheets %}
    ...
    {{ encore_entry_link_tags('easyAutocomplete') }}
{% endblock %}
{% block javascripts %}
