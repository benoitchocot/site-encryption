...
class __TwigTemplate_5ffbcdebecd247be85a4c92f484f088bc002f19d14545ef6af16a74f5879e5c2 extends Template
{
    private $source;
    private $macros = [];
    ...
    <span class=\"float-right\">
        ...
        if ((isset($context["sorted"]) || array_key_exists("sorted", $context) ? $context["sorted"] : (function () { throw new RuntimeError('Variable "sorted" does not exist.', 11, $this->source); })())) {
            // line 12
            yield "            ";
            if ((0 === CoreExtension::compare((isset($context["direction"]) || array_key_exists("direction", $context) ? $context["direction"] : (function () { throw new RuntimeError('Variable "direction" does not exist.', 12, $this->source); })()), "desc"))) {
                // line 13
...
", "@KnpPaginator/Pagination/twitter_bootstrap_v4_font_awesome_sortable_link.html.twig", "/home/bonoit/Projets Web/site-encryption/vendor/knplabs/knp-paginator-bundle/templates/Pagination/twitter_bootstrap_v4_font_awesome_sortable_link.html.twig");
    }
}
