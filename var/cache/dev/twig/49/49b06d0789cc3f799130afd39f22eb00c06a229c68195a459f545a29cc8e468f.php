...
class __TwigTemplate_fd60eff571b9a9764762100a4d7ac57e52383078d247e0e9c465ce56ccda42b4 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["token"]) || array_key_exists("token", $context))) ? (Twig\Extension\CoreExtension::default((isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 6, $this->source); })()), "")) : ("")), "latest"))) ? ("There are no profiles") : ("Token not found")), "message" => (((0 === CoreExtension::compare(((        // line 7
(isset($context["token"]) || array_key_exists("token", $context))) ? (Twig\Extension\CoreExtension::default((isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 7, $this->source); })()), "")) : ("")), "latest"))) ? ("No profiles found.") : ((("Token \"" . (((isset($context["token"]) || array_key_exists("token", $context))) ? (Twig\Extension\CoreExtension::default((isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 7, $this->source); })()), "")) : (""))) . "\" not found.")))]];
        // line 1
